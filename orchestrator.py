...
async def generate_action(request: ActionRequest):
    ...
    format_block = (
        'Твой ответ должен быть простым текстом, разделенным на два блока: '
        '"Мысли ([THOUGHTS])" и "Действие / Речь ([ACTION/SPEECH])". '
        'Сначала напиши скрытые мысли персонажа, затем то, что он делает или говорит вслух.'
    )

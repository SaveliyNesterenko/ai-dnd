...
def create_archivist_prompt(event_summary, previous_chronicle):
    """
    Формирует промт для "Архивариуса".
    """
    instruction = """Ты — Синтезатор Хроники. Твоя задача — поддерживать единую и актуальную летопись игровых событий. Проанализируй новые события и обнови существующую хронику, создав единый, целостный текст."""

    previous_chronicle_str = "\n".join(previous_chronicle) if previous_chronicle else "Хроника пока пуста."
